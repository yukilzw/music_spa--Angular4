...
export class common {
    ...
    loading(){
        ...
        let body:NodeListOf<any> = document.getElementsByTagName("body")
        if(shadowBox.length)return;
    ...
    loadingRemove(){
        let shadowBox:HTMLCollectionOf<any> = document.getElementsByClassName("showbox")
        let body:NodeListOf<any> = document.getElementsByTagName("body")
